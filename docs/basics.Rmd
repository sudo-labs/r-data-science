...
We're going to start with the absolute fundamentals and work up from there.
Unlike most regular courses, we'll try to go in-depth into performance-related
stuff as we go (keep the more advanced people interested that way...).
